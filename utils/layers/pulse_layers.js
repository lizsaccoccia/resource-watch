    ...
    layers: [
      {
        ...
        descriptionPulse:
          <div className="description">
            <div className="description-text">
              Nitrogen dioxide (NO₂) is released into the atmosphere from the burning of fossil fuels and breathing air with high concentrations of NO₂ can result in respiratory symptoms.  These air quality measurements are collected from government and research sources by OpenAQ.
            </div>
            <div className="view-with-container">
              <span className="view-with-label"><strong>View with:</strong></span>
              <LayerPill layerId="84229e01-4e61-4c08-a7dd-efb7259dd85d" label="Population" />
        ...
        descriptionPulse:
          <div className="description">
            <div className="description-text">
              Carbon monoxide (CO) is a colorless, odorless gas is released when something is burned and can be harmful to human health if inhaled in high concentrations.  These air quality measurements are collected from government and research sources by OpenAQ.
            </div>
            <div className="view-with-container">
              <span className="view-with-label"><strong>View with:</strong></span>
              <LayerPill layerId="84229e01-4e61-4c08-a7dd-efb7259dd85d" label="Population" />
